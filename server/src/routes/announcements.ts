...
import { validateAddCommentDto, validateAddReactionDto, validatePaginationDto, validateCreateAnnouncementDto } from "../validation/dto";
...
router.post(
    ...
    async (req: express.Request, res: express.Response, next: express.NextFunction) => {
        try {
            ...
            const dto = validateAddReactionDto(merged);
